                ...
                <div class="card-body">
                    ...
                    <div class="col-xxl col-xl-12">
                        <div class="card info-card customers-card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">
                                    <div class="text-primary">Selamat Datang</div>
                                </h5>
                                <div class="d-flex align-items-center">
                                    <h3>SISTEM ANTRIAN PUSKESMAS SEHAT</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card border-left-primary shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="h5 mb-0 font-weight-bold text-gray-800 content-center">Manage
                                                    User</div>
                                            </div>
                                            <div class="col-auto">
                    ...
                    <div class="col-4 col-md-4 mb-3">
                        <div class="card border-left-primary shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">Daftar Antrian</div>
                                    </div>
                                    <div class="col-auto">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-hospital" viewBox="0 0 16 16">
